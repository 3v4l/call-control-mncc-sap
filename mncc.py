...
MNCC_CALL_PROC_IND = 298 # Variable c_int '298'
int8_t = c_int8
int16_t = c_int16
int32_t = c_int32
int64_t = c_int64
...
__all__ = ['GSM48_BCAP_SA_X28_DP_UN', 'gsm_mncc_number',
           ...
           'MNCC_ALERT_IND', 'MNCC_PROGRESS_IND', 'intmax_t', '__GLIBC__',
           ...
           'MNCC_CALL_PROC_REQ', 'MNCC_CALL_PROC_IND', 'WINT_MAX', '_BSD_SOURCE',
